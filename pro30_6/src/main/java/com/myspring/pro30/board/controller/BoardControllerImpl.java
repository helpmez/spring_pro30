...
public class BoardControllerImpl implements BoardController {
	...
	// 기본생성자를 통해 빈을 셋팅 
	// public void BoardControllerImpl() { } 
	// boardController 빈에 BoardService타입의 빈을 주입
	// 왜? 결합도를 낮추려고 낮추면 유지보수 편리해짐 
	// BoardService에 주입은 왜? 메서드 쓸려고 listArticles 쓸수있음
	// 어덯게 주입시키는데? 
	// <bean id="BoardService" class= "BoardServiceImpl"/> => 주입해줄 대상
	// <bean id="BoardController" class= "BoardControllerImpl ">  => 주입받을 대상
	//   <property name= "BoardService" ref="BoardService"/> => 주입시켜줄 세터함수,주입해줄 대상 지정 
	// </bean>
	// public void setBoardService(BoardService boardService) {
	//  	this.boardService = boardService;
	// }
	// 결론 : 먼저 참조하고싶은 클래스의 빈을 생성한다. 그 빈을 사용할 클래스의 빈을 생성한다. 
	// 		 (참조할 클래스의 빈) ==주입==> (사용할 클래스의 빈) 
	// 어노테이션을 썼으므로 세터함수와 별도의 생성자는 생략한다. 
	// 의문점 : component로 빈을 생성해줘야하는데 BoardService 어디에도 component가 없다
	@Autowired
